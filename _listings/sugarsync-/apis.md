...
- name: Sugar Sync  API Retrieving Album Information
  ...
  baseURL: https://api.sugarsync.com////album/
  tags: Album
  properties:
...
- name: Sugar Sync  API Creating a Refresh Token
  ...
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/488-sugarsync-.jpg
  humanURL: http://sugarsync.com
  baseURL: https://api.sugarsync.com////app-authorization
...
- name: Sugar Sync  API Creating an Access Token
  ...
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/488-sugarsync-.jpg
  humanURL: http://sugarsync.com
  baseURL: https://api.sugarsync.com////authorization
  tags: Authorization
  properties:
  - type: x-postman-collection
...
- name: Sugar Sync  API Retrieving Contact Information
  ...
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/488-sugarsync-.jpg
  humanURL: http://sugarsync.com
  baseURL: https://api.sugarsync.com////contact/
  tags: Contact
  properties:
  - type: x-postman-collection
...
- name: Sugar Sync  API Retrieving File Data
  ...
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/488-sugarsync-.jpg
  humanURL: http://sugarsync.com
  baseURL: https://api.sugarsync.com////file
  tags: File
  properties:
  - type: x-postman-collection
...
- name: Sugar Sync  API Retrieving Folder Information
  ...
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/488-sugarsync-.jpg
  humanURL: http://sugarsync.com
  baseURL: https://api.sugarsync.com////folder
  tags: Folder
  properties:
  - type: x-postman-collection
...
- name: Sugar Sync  API Retrieving Received Share Information
  ...
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/488-sugarsync-.jpg
  humanURL: http://sugarsync.com
  baseURL: https://api.sugarsync.com////receivedShare/
  tags: ReceivedShare
  properties:
  - type: x-postman-collection
...
- name: Sugar Sync  API Retrieving User Information
  ...
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/488-sugarsync-.jpg
  humanURL: http://sugarsync.com
  baseURL: https://api.sugarsync.com////user
  tags: User
  properties:
  - type: x-postman-collection
...
- name: Sugar Sync  API Retrieving Workspace Information
  ...
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/488-sugarsync-.jpg
  humanURL: http://sugarsync.com
  baseURL: https://api.sugarsync.com////workspace
  tags: Workspace
  properties:
  - type: x-postman-collection
...
- name: Sugar Sync  API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/sugarsync-/master/_listings/sugarsync-/openapi.md
x-common:
